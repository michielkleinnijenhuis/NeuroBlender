...
class NeuroBlenderSettingsPanel(Panel):
    ...
    def draw_nb_panel(self, layout, nb):
        ...
        row.operator(AddPresetNeuroBlenderSettings.bl_idname,
                     text="", icon='ZOOMIN')
        row.operator(AddPresetNeuroBlenderSettings.bl_idname,
    ...
    def drawunit_manage_colourmaps(self, layout, nb):
        ...
        row = layout.row(align=True)
        row.menu(OBJECT_MT_colourmap_presets.__name__,
                 text=OBJECT_MT_colourmap_presets.bl_label)
        row.operator(AddPresetNeuroBlenderColourmap.bl_idname,
                     text="", icon='ZOOMIN')
        row.operator(AddPresetNeuroBlenderColourmap.bl_idname,
                     text="", icon='ZOOMOUT').remove_active = True
        ...
        try:
            ...
            layout.separator()
            layout.operator(ResetColourmaps.bl_idname)
...
def colourmap_enum_callback(self, context):
    ...
    def order_cmaps(mapnames, pref_order):
        ...
        if mapnames:
            mapnames_ordered.append(mapnames)
