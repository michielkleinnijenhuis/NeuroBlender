...
# -*- coding: utf-8 -*-
#
# NeuroBlender documentation build configuration file, created by
...
project = 'NeuroBlender'
copyright = '2017, Michiel Kleinnijenhuis'
...
htmlhelp_basename = 'NeuroBlenderdoc'
...
latex_documents = [
    (master_doc, 'NeuroBlender.tex', 'NeuroBlender Documentation',
     'Michiel Kleinnijenhuis', 'manual'),
]
...
man_pages = [
    (master_doc, 'neuroblender', 'NeuroBlender Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NeuroBlender', 'NeuroBlender Documentation',
     author, 'NeuroBlender', 'One line description of project.',
     'Miscellaneous'),
]
